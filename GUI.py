...
#SCRIPTS TO RUN RECONSTRUCTOR and IDENTIFIER
...
def reconstruct(root):
    ...
    #takes in user uploads and saves to the directory
    #updates the file path for the program to use the image
    def upload_photo():
...
#functions to update display of the most recent reconstruction
...
def identifyresult(root):
    ...
    #UI elements and configurations
    cleanPage(root)
    global myFont
    myFont = font.Font(family="Helvetica")
    global background, backgroundpic
    ...
    #IDENTIFIER========================
    try:
        #read and strip the image file from whitespaces
        with open(file_path1, "r") as file:
            file_content = file.read().strip() 
            print(file_content)
        
        #resize and display the image file in the GUI
        ...
        #labels of the painters (with threshold)
        labels = {0: 'Vincent_van_Gogh', 1: 'Edgar_Degas', 2: 'Pablo_Picasso', 
                  3: 'Pierre-Auguste_Renoir', 4: 'Albrecht_Dürer', 5: 'Paul_Gauguin', 
                  6: 'Francisco_Goya', 7: 'Rembrandt', 8: 'Alfred_Sisley', 9: 'Titian', 
                  10: 'Marc_Chagall'}
        ...
        #reads the image as an array, normalize pixel values
